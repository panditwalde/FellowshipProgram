...
.search {width: 500px;height: 40px;margin: 71px;     margin-left: 364px; auto;background: #444;background: rgba(0,0,0,.2);border-radius:  3px;border: 1px solid #fff;}
...
<body>
	...
	<form class="search" action="searchdata" method="get">
